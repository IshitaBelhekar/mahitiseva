...
<?php include 'sidebar.php'; ?> 
 ...
 <a href="event_details.php" class="btn btn-danger">Add New Event</a></h3>      
  <h4 class="sub-title" style="color: chocolate;font-size: 20px;">
Events List:</h4>       
...
<div style="width: 100%;overflow: scroll;">
   ...
   <tbody >  
      ...
      ORDER BY c.e_date DESC";
       ...
       ?><tr>
            <td>
            <?php echo "MASS/EV/".date('Y')."/".$e_id; ?></td>
             <td><?php echo convertdate($res['e_date'])."<br> (".$res['e_timestamp'].")" ; ?></td>
         <td>  <?php if($res['e_status']==2){ ?> <button class="btn btn-danger">Inactive</button>
 <?php } else if($res['e_status']==1){ ?>  <button class="btn btn-success">Active</button> <?php } ?>
</td>
  <td><?php echo $res['eca_title']; ?></td>
             <td><?php echo $res['e_title']; ?></td>
             
               <td><?php echo $res['e_venu']; ?></td>
                <td><a href="event_details.php?e_id=<?php echo $e_id; ?>" target="_blank" style="font-weight: 700;color: chocolate;">
                <button>Edit</button></a>
                <a href="../event-details.php?e=<?php echo $e_id; ?>&s=<?php echo $e_slug; ?>" target="_blank" style="font-weight: 700;color: chocolate;">
