...
<body class="custom-cursor">
   ...
   <?php include 'header.php';?>
        ...
        <section class="service-details" style= "padding: 80px 0px 10px;">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xl-8 col-lg-7">
                        <div class="services-details__right">
                            <div class="services-details__img-1">
                                <img src="assets/images/About-img/cow.jpg" alt="">
                            </div>
                            <h3 class="services-details__title-1">Chara vatap</h3>
                            <p class="services-details__text-1" style="text-align: justify">As a grass-fed and grass-finished operation, we take a different approach to beef production. When calves are weaned, they dont go to feed yards to be finished in a conventional program. Instead, they come to the finishing pasture and are met with a constant, controlled salad bar thats designed to be the best ration they need. This provides them with feed that is proper for a ruminant animal, but it also creates a remarkable end product.</p>
                            <p class="services-details__text-2" style="text-align: justify">When it comes to flavor, an animal really is what it eats. At Mahitiseva, we are particular about our cattle, but we are also particular about their diet.</p>
                            <p class="services-details__text-3" style="text-align: justify">Feeding cows properly is crucial for their health, well-being, and productivity. The nutritional needs of cows vary depending on factors such as age, breed, stage of production (e.g., lactating or dry), and overall health.</p>
                            </div>
                    </div>
                        ...
                        <div class="services-details__sidebar">
                            <div class="services-details__services-list">
                                <ul class="services-details__services list-unstyled">
                                    <li class="active">
                                        <a href="treeplantation.php"><span class="fas fa-leaf"></span>Tree Plantation
                                            </a>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <a href="social.php"><span class="fas fa-leaf"></span>Social Service with School</a>
                                    </li>
                                    <li>
                                        <a href="chara.php"><span class="fas fa-leaf"></span>Chara Vattap
                                            </a>
                                    </li>
                             ...
                             <div class="banner-one">
                                ...
                                <div class="banner-one__img"
                                    style="background-image: url(assets/images/cow2.webp);"></div>
...
<ul class="services-details__points-list list-unstyled">
                                <li>
                                    <div class="services-details__icon-and-title">
                                        ...
                                        <h3 class="services-details__points-title">We
                                            <br>Provide Care </h3>
                                    </div>
                                    <p class="services-details__points-text" style="text-align: justify">Todays youth need a helpful hand and right guidance at every stage. Heres where we take care of them like our own.</p>
                                </li>
                                <li>
                                    <div class="services-details__icon-and-title">
                                        <div class="services-details__points-icon">
                                    ...
                                    <p class="services-details__points-text" style="text-align: justify">We run organizations where we employ youngsters so they can live their dreams for themselves and their families.</p>
                                </li>
                                <li>
                                    <div class="services-details__icon-and-title">
                                        <div class="services-details__points-icon">
                                    ...
                                    <p class="services-details__points-text" style="text-align: justify">We run small-scale schools for the underprivileged children and youth of daily wage workers for a better future.</p>
                                </li>
                            </ul>
                                ...
                                <div class="row">
                                    <div class="col-xl-6">
                                        <div class="services-details__benefit-img">
                                            <img src="assets/images/About-img/cow2.jpg" alt=" " style = "width:100%; height:400px;">
                                        </div>
                                    </div>
                                    <div class="col-xl-6">
                                        <div class="services-details__benefit-content">
                                            <h3 class="services-details__benefit-title">Our benefits</h3>
                                            <p class="services-details__benefit-text">our Earth is in brilliant hands
                                                for our Mahiti Seva</p>
                                            <ul class="services-details__benefit-points list-unstyled">
                                                <li>
                                                    ...
                                                    <div class="text">
                                                        <p>Cultivation cost and maintenance of green fodder is low.</p>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="icon">
                                                    ...
                                                    <div class="text">
                                                        <p>Produced green fodder can be made into silage and used for future</p>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="icon">
                                                    ...
                                                    <div class="text">
                                                        <p>Green fodder cultivation cut the cost of feed.</p>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="icon">
                                                    ...
                                                    <div class="text">
                                                        <p>Natural way of nutrients for animals and plays major role in livestock growth and health</p>
                                                    </div>
                                                </li>
                                            </ul>
                                        </div>
...
<div class="container" style="margin-top:100px;">
	...
	<h5 style="text-align:center;">Donate For Chara Vatap</h5>
	  <div class="progress mb-3" style="margin-top:40px;">
        <div class="progress-bar bg-success" role="progressbar" style="width: 40%;" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100">50%</div>
                           </div>
                             
                             <div class="row" style="margin-top:20px;">
                              <div class="col">
                                         <p style="font-size:16px;"><i style='font-size:16px' class='fas'>&#xf156;</i>120</p>
          ...
          <form >
            <div class="row form-row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" id="amount" class="form-control" placeholder="500" required>
                </div>
                <div class="form-group">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" id="name" class="form-control" placeholder="eg. Neha Pokharna" required>
                </div>
                <div class="form-group">
                  <label for="contact">Contact No</label>
                  <input type="text" id="contact" class="form-control" placeholder="Your Contact No" required>
                </div>
                <div class="form-group">
                  <label for="postal">Pin/Postal Code</label>
                  <input type="text" id="postal" class="form-control" placeholder="Your Contact No" required>
                </div>
              </div>
            </div>
            <div class="container">
            ...
            <div class="form-group">
              <div class="form-check">
                ...
                <label class="form-check-label" for="agree">I agree with the privacy policy</label>
              </div>
            </div>
