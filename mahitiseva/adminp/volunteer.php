...
<?php include 'sidebar.php'; ?> 
                                        ...
                                        <div class="col-lg-4">
                                            <div class="page-header-breadcrumb">
                                                <ul class="breadcrumb-title">
                                                    ...
                                                    <li class="breadcrumb-item"><a href="#!">Volunteers Applications List</a>
                                                    </li>
 ...
 <div class="card-block">   
<h4 class="sub-title" style="color: chocolate;font-size: 20px;">
Volunteers Applications List:</h4>       
...
<div style="width: 100%;overflow: scroll;">
   ...
   <tbody >  
            ...
            $toatalamount=0;$tdoners=0;
                $qot = "SELECT * FROM volunteer_details  ORDER BY v_date DESC";
                ...
                while ($rest = mysqli_fetch_array($queryht)) { 
                 ...
                 if($rest['v_status']==2){    ?><tr style="background: #e2fff5;">
                 <?php } else { ?><tr style="background: antiquewhite;"> <?php } ?>
            <td>
            <?php echo "MASP/VL/".$rest['v_id']; ?></td>
              <td><?php echo convertdate($rest['v_date']);  ?> </td>
           <td><?php echo $rest['v_name']; ?></td>
            <td><?php echo $rest['v_contact']; ?></td>
 <td>  <?php if($rest['v_status']==2){ ?> <a href="action-controller.php?verifyvol=1&v_id=<?php echo $rest['v_id']; ?>" class="btn btn-success">Verified</a>
 <?php } else if($rest['v_status']==1){ ?>  <a  href="action-controller.php?verifyvol=2&v_id=<?php echo $rest['v_id']; ?>" class="btn btn-danger">Unverified
 </a> <?php } ?>
</td>
        <td><?php echo $rest['v_email']; ?></td>
 <td><?php echo convertdate($rest['v_dob']); ?></td>
             <td><?php echo $rest['v_education']; ?></td>
              <td><?php echo $rest['v_address']; ?></td>
                <td><?php echo $rest['v_timestamp']; ?></td>
                 <td><a  href="action-controller.php?deletevol=1&v_id=<?php echo $rest['v_id']; ?>" onclick="return confirm('Are you sure you want to delete?');" class="btn btn-danger"> <i class="feather icon-trash"></i></a></td>
               </tr> <?php } ?>
     </tbody>     
     </table>         
    </div>
