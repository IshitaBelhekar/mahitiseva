...
<?php include 'sidebar.php'; ?> 
                                        ...
                                        <div class="col-lg-4">
                                            <div class="page-header-breadcrumb">
                                                <ul class="breadcrumb-title">
                                                    ...
                                                    <li class="breadcrumb-item"><a href="#!">Contact Us Applications List</a>
                                                    </li>
 ...
 <div class="card-block">   
<h4 class="sub-title" style="color: chocolate;font-size: 20px;">
Contact Us Applications List:</h4>       
...
<div style="width: 100%;overflow: scroll;">
   ...
   <tbody >  
            ...
            $toatalamount=0;$tdoners=0;
                $qot = "SELECT * FROM contact_details  ORDER BY con_date DESC";
                ...
                while ($rest = mysqli_fetch_array($queryht)) { 
                 ...
                 if($rest['con_status']==2){    ?><tr style="background: #e2fff5;">
                 <?php } else { ?><tr style="background: antiquewhite;"> <?php } ?>
            <td>
            <?php echo "MASS/VL/".$rest['con_id']; ?></td>
              <td><?php echo convertdate($rest['con_date']);  ?> </td>
           <td><?php echo $rest['con_name']; ?></td>
            <td><?php echo $rest['con_contact']; ?></td>
 <td>  <?php if($rest['con_status']==2){ ?> <a href="action-controller.php?verifycon=1&v_id=<?php echo $rest['con_id']; ?>" class="btn btn-success">Verified</a>
 <?php } else if($rest['con_status']==1){ ?>  <a  href="action-controller.php?verifycon=2&v_id=<?php echo $rest['con_id']; ?>" class="btn btn-danger">Unverified
 </a> <?php } ?>
</td>
        <td><?php echo $rest['con_email']; ?></td>
 <td><?php echo convertdate($rest['con_message']); ?></td>
         
                <td><?php echo $rest['con_timestamp']; ?></td>
                 <td><a  href="action-controller.php?deletecon=1&v_id=<?php echo $rest['con_id']; ?>" onclick="return confirm('Are you sure you want to delete?');" class="btn btn-danger"> <i class="feather icon-trash"></i></a></td>
               </tr> <?php } ?>
     </tbody>     
     </table>         
    </div>
