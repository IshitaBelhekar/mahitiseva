       ...
       <h6 style=" color: green;">
         <?php    if(isset($_GET['msg'])){
                                        ...
                                        <div class="col-lg-4">
                                            <div class="page-header-breadcrumb">
                                                <ul class="breadcrumb-title">
                                                    ...
                                                    <li class="breadcrumb-item"><a href="#!">Blog Categories List</a>
                                                    </li>
              ...
              if(isset($_GET['bca_id'])){
                  $bca_id=$_GET['bca_id'];
$q="SELECT * FROM blog_categories WHERE bca_id='$bca_id'";
$query=mysqli_query($con,$q);
 while ($res=mysqli_fetch_array($query)) {   ?>  
                       <h4 class="sub-title" style="color: chocolate;font-size: 20px;">
 Update blog Category Details:</h4>                                                    
<form action="action-controller.php" method="post" >
<input name="bca_id" value="<?php echo $res['bca_id']; ?>" type="hidden" required>
<label> blog Category:</label>
<input name="ec_name" value="<?php echo $res['bca_title']; ?>"   type="text" class="form-control" required>
<br><button name="updateevencate" type="submit" class="btn btn-success" > Update </button>
</form>                        
<?php  } }  else { ?>          
 <h4 class="sub-title" style="color: chocolate;font-size: 20px;">
 Add blog Category Details:</h4>                                                    
<form action="action-controller.php" method="post">
<label> blog Category:</label>
...
<div style="width: 100%;">
   ...
   <tbody>
            ...
            <?php
$q="SELECT * FROM blog_categories ORDER BY bca_id";
$query=mysqli_query($con,$q);
 while ($res=mysqli_fetch_array($query)) {   ?> 
      <tr>
            <td ><?php echo $res['bca_id']; ?></td>
         <td ><?php echo $res['bca_title']; ?></td>
           <td> <a href="blog-categories.php?bca_id=<?php echo $res['bca_id']; ?>" ><button>Edit</button></a>
        </td>
