...
<?php include 'sidebar.php'; ?> 
       ...
       <h6 style=" color: green;">
         <?php    if(isset($_GET['msg'])){
                                        ...
                                        <div class="col-lg-4">
                                            <div class="page-header-breadcrumb">
                                                <ul class="breadcrumb-title">
                                                    ...
                                                    <li class="breadcrumb-item"><a href="#!">Bank's List</a>
                                                    </li>
              ...
              if(isset($_GET['ec_id'])){
                  $ec_id=$_GET['ec_id'];
                  $q="SELECT * FROM bank_list WHERE b_id='$ec_id'";
$query=mysqli_query($con,$q);
 while ($res=mysqli_fetch_array($query)) {   ?>  
                       <h4 class="sub-title" style="color: chocolate;font-size: 20px;">
 Update Bank Details:</h4>                                                    
<form action="insertar.php" method="post" >
<input name="ec_id" value="<?php echo $res['b_id']; ?>" type="hidden" required>
<label> Bank Name:</label>
<input name="ec_name" value="<?php echo $res['b_name']; ?>"   type="text" class="form-control" required>
<br><button name="updatebankl" type="submit" class="btn btn-success" > Update </button>
...
<br><button name="addbankl" type="submit" class="btn btn-success" > Add </button>
...
<div style="width: 100%;">
   ...
   <tbody>
            ...
            <?php
$q="SELECT * FROM bank_list ORDER BY b_id";
$query=mysqli_query($con,$q);
 while ($res=mysqli_fetch_array($query)) {   ?> 
      <tr>
            <td ><?php echo $res['b_id']; ?></td>
         <td ><?php echo $res['b_name']; ?></td>
           <td> <a href="banks_list.php?ec_id=<?php echo $res['b_id']; ?>" ><button>Edit</button></a>
        </td>
