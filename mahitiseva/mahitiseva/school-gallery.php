...
<head>
    ...
    <title> Gallery || gardon || gardon HTML 5 Template </title>
    <!-- favicons Icons -->
            ...
            <div class="container">
                <div class="row masonary-layout">
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6">
                        <div class="gallery-page__single">
                            <div class="gallery-page__img">
                                <img src="assets/images/social-event1/img1.jpg" alt="">
                                <div class="gallery-page__icon">
                                    <a class="img-popup" href="assets/images/social-event1/img1.jpg"><span
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6">
                        <div class="gallery-page__single">
                            <div class="gallery-page__img">
                                <img src="assets/images/social-event1/img2.jpg" alt="">
                                <div class="gallery-page__icon">
                                    <a class="img-popup" href="assets/images/social-event1/img2.jpg"><span
                                            class="icon-plus"></span></a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6">
                        <div class="gallery-page__single">
                            <div class="gallery-page__img">
                                <img src="assets/images/social-event1/img3.jpg" alt="">
                                <div class="gallery-page__icon">
                                    <a class="img-popup" href="assets/images/social-event1/img3.jpg"><span
                                            class="icon-plus"></span></a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6">
                        <div class="gallery-page__single">
                            <div class="gallery-page__img">
                                <img src="assets/images/social-event1/img4.jpg" alt="">
                                <div class="gallery-page__icon">
                                    <a class="img-popup" href="assets/images/social-event1/img4.jpg"><span
                                            class="icon-plus"></span></a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6">
                        <div class="gallery-page__single">
                            <div class="gallery-page__img">
                                <img src="assets/images/social-event1/img5.jpg" alt="">
                                <div class="gallery-page__icon">
                                    <a class="img-popup" href="assets/images/social-event1/img5.jpg"><span
                                            class="icon-plus"></span></a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6">
                        <div class="gallery-page__single">
                            <div class="gallery-page__img">
                                <img src="assets/images/social-event1/img6.jpg" alt="">
                                <div class="gallery-page__icon">
                                    <a class="img-popup" href="assets/images/social-event1/img6.jpg"><span
                                            class="icon-plus"></span></a>
                                </div>
                            </div>
                        </div>
