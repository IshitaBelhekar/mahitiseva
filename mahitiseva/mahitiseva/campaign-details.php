...
<script>
    function playYouTubeVideo(videoId) {
        ...
        <div class="row">
                    ...
                    <div class="col-xl-6 col-lg-7">
                        <div class="services-details__right">
                            <h3 class="services-details__title-1"><?php echo $res['camp_title']; ?></h3>  <br>
                            <h3 class="services-details__title-1"><?php echo $res['camp_startdate']; ?></h3> <br>
                            <h3 class="services-details__title-1"><?php echo $res['org_name']; ?></h3>    
                       </div>
...
<div class="container" style="margin-top:40px; margin-bottom:40px;">
  <div class="row justify-content-center">
    <div class="col-12">
      <div class="card" style="width=100%; margin-right:0px; background-color:#2e522e; color:white;">
          ...
          <input type="hidden" name="c" value="<?php echo $comp_id; ?>">
           <input type="hidden" name="s" value="<?php echo $_GET['s']; ?>">
            ...
            <div class="form-group" style="text-align:center;">
              <button type="submit" name="submitdonation" class="btn btn-primary" style="background-color:#2ab939; border-color:#2ab939; color:white;padding: 15px 30px;">Submit</button>
            </div>
          </form>
        </div>
      </div>
   ...
   <div class="services-details__text-1" style="text-align: justify">
         ...
         <div class="services-details__sidebar">
                            ...
                            <div class="banner-one">
                               ...
                               <div class="banner-one__btn-box">
                                    <a href="contact.php" class="banner-one__btn thm-btn">Contact us</a>
                                </div>
                            </div>
 ...
 <?php   $k=1;
               $qot = "SELECT * FROM  campaign_images WHERE camp_id='$camp_id'";
                ...
                while ($rest = mysqli_fetch_array($queryht)) { 
                 ...
                 ?>  
   <a href="<?php echo "camp-documents/".$c_mainimage; ?>" target="_blank"> <img src="<?php echo "camp-documents/".$c_mainimage; ?>" alt="Image 1" ></a>
      <?php }  $k+=1; } ?>
