...
<body class="custom-cursor">
    ...
    <div class="page-wrapper">
                    ...
                    <div class="col-xl-8 col-lg-7">
                        <div class="services-details__right">
                            <div class="services-details__img-1">
                                <img src="assets/images/treeplant.jpg" alt="">
                            </div>
                            <h3 class="services-details__title-1">Tree Plantation</h3>
                            <p class="services-details__text-1" style="text-align: justify">Tree plantation is a fundamental act in environmental conservation,
                             vital for restoring ecosystems and combating climate change. It involves strategically planting trees
                              in various landscapes, including forests, urban areas, and degraded lands. The benefits are manifold:
                               trees absorb carbon dioxide, improve air quality, prevent soil erosion, and provide habitats for
                                wildlife. Additionally, they offer economic opportunities through sustainable forestry and contribute
                                 to community resilience. Tree plantation initiatives often involve partnerships between governments,
                                  non-profit organizations, and local communities. By fostering awareness and engaging stakeholders, 
                                  tree plantation efforts strive to create greener, healthier, and more sustainable environments
                                   for present and future generations..</p>
                            <p class="services-details__text-2">We care about our environment and future</p>
                            <p class="services-details__text-3">Tree plantation secures our future by combating climate change,
                             preserving biodiversity, and enhancing ecosystem resilience. It's a vital step towards creating
                              sustainable environments for generations to come.</p>     
                       </div>
                    </div>
     ...
     <!--     <section class="benefits-icons"  style="align-items:center;">             
 <div class="container">
 <h3 class="benefits" style="margin-bottom: 30px; text-align:center;">Benefits of Tree Plantation</h3>
  <div class="row">
    <div class="col">
     <img src="assets/images/icons/healing.gif" alt="" style="width:100px; height:105px;">
     <h6>Healing</h6>
    </div>
    <div class="col">
         <img src="assets/images/icons/food.gif" alt="" style="width:100px; height:105px;">
     <h6>Food</h6>
    
    </div>
    <div class="col">
         <img src="assets/images/icons/lifestyle.gif" alt="" style="width:100px; height:105px;">
     <h6>Active Lifestyle</h6>
    
    </div>
    <div class="col">
         <img src="assets/images/icons/oxygen.gif" alt="" style="width:100px; height:105px;">
     <h6>Oxygen</h6>
...
<div class="container" style="margin-top:100px;">
	...
	<h5 style="text-align:center;">Donate For Tree Plantation</h5>
